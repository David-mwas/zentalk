    ...
    <nav className="bg-blue-500  p-4 fixed w-screen z-[999] h-[80px] flex items-center justify-between">
      <div className="container mx-auto flex items-center justify-between w-full relative">
        <div className="flex items-center">
          <a href="/"><h1 className="text-white font-bold text-3xl">ZenTalk</h1></a>
        ...
        {isOpen && (
          <div
            className="md:hidden flex bg-blue-500 justify-center gap-[50px] font-semibold absolute w-[50vw] h-[100vh] flex-col items-start px-8 top-[60px] left-[-20px] shadow-md rounded-r-[30px] transition-transform ease-in-out duration-700 z-[888]"
            onClick={openNav}
          >
            <a href="#about" className="text-white hover:text-gray-200">
              About
